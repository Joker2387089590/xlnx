...
export UBootDtsFile=/home/peta-user/repo/xlnx/scripts/zynq-user-uboot.dts
export KernelDtsFile=/home/peta-user/repo/xlnx/scripts/zynq-user-kernel.dts

export DtsName=zynq-user
export XsaName=$(basename $UserXsaFile .xsa)
export XsaFile=$(pwd)/build/hw/$XsaName.xsa

export SourcesDir=/home/peta-user/repo/xlnx
