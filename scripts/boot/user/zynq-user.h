#ifndef __CONFIG_ZYNQ_USER_H
#define __CONFIG_ZYNQ_USER_H
...
#define BOOTENV_DEV_SD(devtypeu, devtypel, instance) \
	"bootcmd_sd="                                             \
		...
		"if mmcinfo; then "                               \
			"load mmc 0:1 0x01000000 system.bit && "  \
			"fpga loadb 0 0x01000000 ${filesize} && " \
			"load mmc 0:1 0x02000000 zImage && "      \
			"load mmc 0:1 0x03000000 system.dtb && "  \
